...
# origin_vis = f"4Res{layer_size}{obj_name}SingleOutput_vis.pt"

origin_vis = f"4Res512{obj_name}SingleOutput_vis.pt"
origin_depth = f"4Res{layer_size}{obj_name}SingleOutput_depth.pt"

vis_model = torch.jit.load(f"../torchScripts/vis/{origin_vis}")
depth_model = torch.jit.load(f"../torchScripts/depth/{origin_depth}")
# VIS PART=======
...
# if(mode_set['save_mode']):
    # cv2.imwrite(f"../test_result/San_Miguel/leaves1_512_VIS.exr", vis_image)
